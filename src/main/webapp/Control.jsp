...
<body>
	...
	<div class="box">
		...
		<br> <a class="button" href="addAuthorities.jsp">Add
			...
			Authorites</a><br>
		<br>
		<br> <a class="button" href="addVehicleModel.jsp">Add VehicleModel</a> <a
			class="button" href="viewVehicle.jsp">View VehicleModel</a> 
			<a class="button" href="updateVehicle.jsp">Update VehicleModel</a> 
			<a class="button" href="deleteVehicle.jsp">Delete VehicleModel</a>
