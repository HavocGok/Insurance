...
<body>
    <div class="background">
		...
		if(s.equals("single")){
			...
			out.println("<table border='1px'><tr><th> Id</th><th>Provider Name</th><th>Insurance Number</th><th>Valid upto</th></tr>");
			out.println("<tr><td>"+IM.getProvider()+"</td><td>"+IM.getInsuranceNumber()+"</td><td>"+IM.getInsuranceDate()+"</td></tr></table>");
		}
        ...
        {
        	InsuranceModelService im = new InsuranceModelService();
        	
        	out.println("<table border='1px'><tr><th> Id</th><th>Provider Name</th><th>Insurance Number</th><th>Valid upto</th></tr>");
			for(InsuranceModel IM:im.viewAllInsurance()){
				out.println("<tr><td>"+IM.getProvider()+"</td><td>"+IM.getInsuranceNumber()+"</td><td>"+IM.getInsuranceDate()+"</td></tr></table>");
			}
			out.println("</table>");
        }
